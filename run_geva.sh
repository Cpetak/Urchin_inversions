...
cd /gpfs1/home/c/p/cpetak/WGS/geva
...
### Link programs
GEVA=/gpfs1/home/c/p/cpetak/WGS/geva
 
### Link inout VCF
INPUT_VCF=$INPUT_VCF


GUIDE=rename_chrs.txt
...
### Model Files
INITPROBS=/gpfs1/home/c/p/cpetak/WGS/geva/hmm/hmm_initial_probs.txt
EMITIONS=/gpfs1/home/c/p/cpetak/WGS/geva/hmm/hmm_emission_probs.txt
...
# Make bin files
$GEVA/geva_v1beta --vcf ${chr}.${start}.${finish}.SNPannotated.forGEVA.vcf --rec 1.25e-7 --out ${chr}.${start}.${finish}
...
#echo "Stopping script in the middle for testing purposes."
#exit 0
